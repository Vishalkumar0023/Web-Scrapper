...
export default function NewScrapePage() {
  ...
  const [prompt, setPrompt] = useState(
    "Extract brand, category, product_family, model, parent_product_id, parent_cluster_id, variant_id, variant_cluster_id, canonical_product_id, cluster_id, cluster_confidence, global_entity_id, match_confidence, sku, sku_confidence, ram, storage, processor, display, os_family, os_version, os, is_canonical_name, name_source, canonical_review_required, list_price_inr, effective_price_inr, discount_percent, price_confidence, price_inr, rating, review_count, review_scope, review_count_timestamp, availability, product_url",
  );
        ...
        <form className="card form-grid" onSubmit={onSubmit}>
          ...
          <label>
            ...
            <textarea
              ...
              placeholder="Extract brand, category, product_family, model, parent_product_id, parent_cluster_id, variant_id, variant_cluster_id, canonical_product_id, cluster_id, cluster_confidence, global_entity_id, match_confidence, sku, sku_confidence, ram, storage, processor, display, os_family, os_version, os, is_canonical_name, name_source, canonical_review_required, list_price_inr, effective_price_inr, discount_percent, price_confidence, price_inr, rating, review_count, review_scope, review_count_timestamp, availability, product_url"
            />
          </label>
